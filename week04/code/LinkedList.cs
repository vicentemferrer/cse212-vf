...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                // If the location of 'value' is at the end of the list,
                // then we can call remove_tail to delete 'value'
                if (curr == _tail)
                {
                    RemoveTail();
                }
                // For any other location of 'value', need to disconnect the node and
                // reconnect previous and next nodes between themselves.
                else
                {
                    curr.Next!.Prev = curr.Prev; // Connect next node to the previous node respect to matched 'value'
                    curr.Prev!.Next = curr.Next; // Connect previous node to the next node respect to matched 'value'
                }
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null) {
            ...
            // Update node data to new value.
            if (curr.Data == oldValue) {
                curr.Data = newValue;
            }

            curr = curr.Next; // Go to the next node to search for old value
        } 
    }
